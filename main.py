...
def plot_fourier_difference(solution_1, solution_2, title):
    ...
    # set bounds of plot
    min_x = 0.0003  # minimum x value on plot
    max_x = 0.0005  # maximum x value on plot
    # min_frequency = int(min_x * time_steps)
    # max_frequency = int(max_x * time_steps)
    min_frequency = 0 #40
...
def mark_peaks(solution_1, solution_2):
    ...
    height_threshold = 2000 # only detect peaks that are at least this tall
